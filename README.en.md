...
Weekly settlement triggers every Sunday evening. The week's adventure gains are aggregated by action class and credited together with the index realization into player wallets; death insurance and the shares market then settle in sequence. Settlement also emits the week's archive and a macro weekly report.
